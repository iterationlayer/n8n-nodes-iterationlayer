...
export const documentExtractionProperties: INodeProperties[] = [
  {
    displayName: "Files",
    name: "files",
    ...
    options: [
      {
        ...
        values: [
          ...
          },
          {
            ...
            default: "{}",
            description:
              'Optional website authentication, for example {"type":"bearer","token":"..."}',
            displayOptions: { show: { fileInputMode: ["url"] } },
          },
          {
            displayName: "Headers",
          ...
          },
          {
            ...
            default: 0,
            description:
              "Optional website fetch timeout in milliseconds. Leave 0 to use the API default.",
            displayOptions: { show: { fileInputMode: ["url"] } },
          },
          {
          ...
          },
          {
            ...
            description: "Optional file name with extension",
          },
        ],
      },
    ],
  },
  {
    ...
    default: "uiBuilder",
    description:
      "Use the UI builder for simple schemas, or raw JSON for advanced features like nested arrays and calculated fields.",
    displayOptions: {
      show: {
        resource: ["documentExtraction"],
      },
